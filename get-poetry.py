    ...
    def display_post_message(self, version):
        ...
        if WINDOWS:
            message = (
                ...
                else POST_MESSAGE_WINDOWS_NO_MODIFY_PATH
            )
            ...
            message = (
                POST_MESSAGE_FISH
                if self._modify_path
                else POST_MESSAGE_FISH_NO_MODIFY_PATH
            )
            ...
            message = (
                POST_MESSAGE_UNIX
                if self._modify_path
                else POST_MESSAGE_UNIX_NO_MODIFY_PATH
            )
